                    ...
                    <ul id="menu-top" class="nav navbar-nav">
                        <li>
                            <a class="<?php if ($this->uri->segment(2) == 'home'){ echo 'menu-top-active ';} ?>" 
                                href="<?=base_url()?>sales/home">Home
                            </a>
                        </li>
                        <li>
                            <a class="<?php if ($this->uri->segment(2) == 'data_pemesanan'){ echo 'menu-top-active ';} ?>" 
                                href="<?=base_url()?>sales/data_pemesanan">Data Pemesanan
                            </a>
                        </li>
                        <li>
                            <a class="<?php if ($this->uri->segment(2) == 'validasi_pembayaran'){ echo 'menu-top-active ';} ?>" 
                                href="<?=base_url()?>sales/validasi_pembayaran">Validasi Pembayaran
                            </a>
                        </li>
                        <li>
                            <a class="<?php if ($this->uri->segment(2) == 'laporan_pemesanan'){ echo 'menu-top-active ';} ?>" 
                                href="<?=base_url()?>sales/laporan_pemesanan">Laporan Pemesanan
                            </a>
                        </li>
                         <li>
                            <a class="<?php if ($this->uri->segment(2) == 'chat'){ echo 'menu-top-active ';} ?>" 
                                href="<?=base_url()?>sales/chat">Chat
                            </a>
                        </li>
                    </ul>
                    <ul id="menu-top" class="nav navbar-nav navbar-right">
                        <li class="dropdown">
                            <a class="dropdown-toggle" data-toggle="dropdown" href="#" aria-expanded="false">
                                sales <span class="glyphicon glyphicon-user"></span>
                            </a>
