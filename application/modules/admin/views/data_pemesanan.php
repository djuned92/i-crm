...
<div class="modal fade" id="tersedia<?=$r->id_pemesanan?>" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form action="<?=base_url()?>admin/data_pemesanan/tersedia/<?=$r->id_pemesanan?>" class="form-horizontal" method="POST">
...
<div class="modal fade" id="tidak_tersedia<?=$r->id_pemesanan?>" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form action="<?=base_url()?>admin/data_pemesanan/tidak_tersedia/<?=$r->id_pemesanan?>" class="form-horizontal" method="POST">
                <div class="modal-body">
...
<div class="modal fade" id="delete<?=$r->id_pemesanan?>" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form action="<?=base_url()?>admin/data_pemesanan/delete/<?=$r->id_pemesanan?>" class="form-horizontal" method="POST">
                <div class="modal-body">
