...
<div class="modal fade" id="valid<?=$r->id_pemesanan?>" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form action="<?=base_url()?>sales/validasi_pembayaran/valid/<?=$r->id_pemesanan?>" class="form-horizontal" method="POST">
...
<div class="modal fade" id="tidak_valid<?=$r->id_pemesanan?>" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form action="<?=base_url()?>sales/validasi_pembayaran/tidak_valid/<?=$r->id_pemesanan?>" class="form-horizontal" method="POST">
                <div class="modal-body">
